...
<ol><li><strong>Volumen de Mercado:</strong> para que la incursión en este nuevo rubro sea justificable, se ha considerado cubrir al menos la mitad más uno de los proyectos disponibles en la región evaluada. Teniendo en cuenta la cantidad actual de proyectos activos en la región (13), lo deseable sería cubrir al menos 7 de estos proyectos.</li><br>
