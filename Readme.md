...
Considerando estos 3 segmentos, podemos clasificar las distintas tecnologías de acceso a internet de acuerdo a los rangos de ancho de banda (<em>BW</em>):
<ul><li><strong>Registro de Sensores y Monitoreo Ambiental</strong>: ADSL, con un BW menor a 5Mbps</li>
<li><strong>Monitoreo Remoto y Gestión de Equipamiento</strong>: 3G, 4G, Wireless (conexión punto a punto con antenas), con un BW de 5Mbbps hasta 20 Mbps</li>
<li><strong>Gestión de Activos y Logística (seguimiento en tiempo real de vehículos, equipos y materiales)</strong>: 4G, Fibra Óptica, Satelital, con un BW de 20Mbps hasta 100 Mbps</li>
<p>La propuesta de inversión se tomará considerando tres factores (KPIs):
<ol><li><strong>Volumen de Mercado:</strong> para que la incursión en este nuevo rubro se considere justificable, se ha considerado cubrir al menos la mitad más uno de los proyectos disponibles en la región evaluada. Para los números actuales que se cuenta con 13 proyectos activos en la región, lo deseable sería cubrir al menos 7 de estos proyectos.
<li><strong>Conectividad Disponible:</strong> con el objeto de aprovechar al máximo los recursos tecnológicos instalados, se evaluará también la conectividad disponibles en las poblaciones y localidades más cercanas a cada uno de los proyectos mineros. Se fijo como valor mínimo, un total de ocho (8) conexiones o accesos.
<li><strong>Costo Obras:</strong> debido a que el emplazamiento de los proyectos mineros se encuentran por lo general alejados de las poblaciones, se considerará la distancia a la localidad más cercana que cuente con conectividad. Este valor de la distancia servirá como indicador del volumen de obras que debrán llevarse a cabo para poder implementar el trabajo. Entre otras tareas se pueden mencionar obras de tendido de cables o fibras, montaje de antes y obras civiles asociadas. También permitirá dimensionar los costos vinculados a la cantidad de metros necesarios de cable o fibra, y a la capacidad de los equipos de transmisión. La distancia máxima considerada como óptima para esta primera incursión en el rubro minero no deberá superar los 720km, contemplando la suma de las distancias entre cada proyecto analizado y la población más cercana al mismo .
<p>Para la decisión final se espera que al menos dos (2) de los tres (3) KPIs sean alcanzados.
<p>Una vez definido esto, se determinará, considerando el tipo de tecnología disponible en la proximidad del proyecto, qué servicio podrá empezar a ensayar para su posterior implementación.
